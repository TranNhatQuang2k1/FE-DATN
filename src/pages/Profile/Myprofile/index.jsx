...
let profile = [
    ...
    {
        title: 'trợ giúp',
        urlImage: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSCrCj9UVNs2rtjfXWx0q8xisUWz1j1_3tSpEYpBnBmP7zTCQCrR-aEvhz0DpVuvHCxr2g&usqp=CAU',
    },
    {
        title: 'Đăng xuất',
...
const ProfileCard = ({title,urlImage}) => {
    return (
